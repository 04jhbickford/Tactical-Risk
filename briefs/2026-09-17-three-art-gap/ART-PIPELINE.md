...
### Land
- [x] **P37 watercolor world albedo** (`assets/three/board/world-land-albedo.png`, 4096×2340) — STYLE REF Oceania parchment. Theater plates through live masks (no rectangular boxes). Runtime fillStain OFF; bind `?v=p37` fail-closed.
