...
export function injectThreeChrome({ seat = 'Russians', ipc = 24, phase = 'PLACE' } = {}) {
  ...
  style.textContent = `
    ...
    #three-bottom {
      ...
      pointer-events:none;
      background:linear-gradient(0deg, rgba(30,36,32,0.7) 0%, transparent 100%);
    }
    #three-peek {
    ...
    #three-zoom button {
      ...
      background:rgba(30,36,32,0.82); color:#E8E2D4;
    ...
    #three-sheet {
      ...
      background:rgba(30,36,32,0.96); color:#E8E2D4;
