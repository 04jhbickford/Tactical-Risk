...
export const PIP_PX = 56;
export const PIECE_PX = 58;
export const PIP_MIN_PX = 50;
export const PIP_MAX_PX = 64;
export const PIECE_MIN_PX = 50;
export const PIECE_MAX_PX = 68;
