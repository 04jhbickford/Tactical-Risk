...
export class UnitRenderer {
  ...
  static SEA_ZONE_OFFSETS = {
    ...
    'Indian Ocean Sea Zone': { x: -184, y: -43 },
    'Mozambique Sea Zone': { x: -8, y: -48 },
    ...
    'Gulf of Mexico Sea Zone': { x: -42, y: -80 },
    'West Australia Sea Zone': { x: 3, y: -8 },
    'East Indies Sea Zone': { x: -21, y: 1 },
    'South Australia Sea Zone': { x: 151, y: -33 },
    'New Zealand Sea Zone': { x: 14, y: 72 },
    'Solomon Islands Sea Zone': { x: -32, y: 76 },
    'New Guinea Sea Zone': { x: -58, y: 1 },
    'Kwangtung Sea Zone': { x: 30, y: -16 },
    'Okinawa Sea Zone': { x: 16, y: -62 },
    'Wake Island Sea Zone': { x: -20, y: 9 },
    'Soviet Far East Sea Zone': { x: -128, y: -64 },
