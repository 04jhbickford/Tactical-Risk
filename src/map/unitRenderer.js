...
export class UnitRenderer {
  ...
  static SEA_ZONE_OFFSETS = {
    ...
    'Gulf of Mexico Sea Zone': { x: -50, y: -80 },
    'West Australia Sea Zone': { x: 9, y: -46 },
    'East Indies Sea Zone': { x: -27, y: -7 },
    'South Australia Sea Zone': { x: 151, y: -33 },
    'New Zealand Sea Zone': { x: -2, y: 38 },
    'Solomon Islands Sea Zone': { x: -42, y: 82 },
    'New Guinea Sea Zone': { x: -70, y: -11 },
    'Kwangtung Sea Zone': { x: 30, y: -16 },
    'Okinawa Sea Zone': { x: 16, y: -62 },
    'Wake Island Sea Zone': { x: -24, y: 39 },
    'Soviet Far East Sea Zone': { x: -140, y: -88 },
