...
export class UnitRenderer {
  ...
  static SEA_ZONE_OFFSETS = {
    ...
    'Gulf of Mexico Sea Zone': { x: -44, y: 924 },
    'West Australia Sea Zone': { x: 7, y: -36 },
    'East Indies Sea Zone': { x: -27, y: -1 },
    'Borneo Sea Zone': { x: -50, y: 152 },
    'South Australia Sea Zone': { x: 151, y: -33 },
    'New Zealand Sea Zone': { x: 40, y: 56 },
    'Solomon Islands Sea Zone': { x: -38, y: 80 },
    'New Guinea Sea Zone': { x: -32, y: -1 },
    'Kwangtung Sea Zone': { x: 30, y: -16 },
    'Okinawa Sea Zone': { x: 16, y: -62 },
    'Wake Island Sea Zone': { x: -20, y: 9 },
    'Soviet Far East Sea Zone': { x: -134, y: -78 },
