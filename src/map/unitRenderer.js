...
export class UnitRenderer {
  ...
  static SEA_ZONE_OFFSETS = {
    ...
    'Gulf of Mexico Sea Zone': { x: -44, y: 916 },
    'West Australia Sea Zone': { x: 3, y: -38 },
    'East Indies Sea Zone': { x: -19, y: -3 },
    'Borneo Sea Zone': { x: -60, y: 150 },
    'South Australia Sea Zone': { x: 151, y: -33 },
    'New Zealand Sea Zone': { x: 40, y: 56 },
    'Solomon Islands Sea Zone': { x: -48, y: 82 },
    'New Guinea Sea Zone': { x: -48, y: -7 },
    'Caroline Islands Sea Zone': { x: -96, y: -6 },
    'Kwangtung Sea Zone': { x: 30, y: -16 },
    'Okinawa Sea Zone': { x: 24, y: -30 },
    'Wake Island Sea Zone': { x: -20, y: -1 },
    'Soviet Far East Sea Zone': { x: -134, y: -74 },
