...
export class UnitRenderer {
  ...
  static SEA_ZONE_CENTERS = {
    ...
    'West Canada Sea Zone': { x: 2996, y: 466 },
    'Alaska Sea Zone': { x: 2870, y: 458 },
    'Soviet Far East Sea Zone': { x: 2558, y: 408 },
    'Midway Sea Zone': { x: 2918, y: 630 },
    'Hawaii Sea Zone': { x: 3058, y: 962 },
    'Wake Island Sea Zone': { x: 2766, y: 1038 },
    'Okinawa Sea Zone': { x: 2568, y: 970 },
    ...
    'East Indies Sea Zone': { x: 2000, y: 1432 },
