#!/usr/bin/env node
// Capture 390 stills for polish.35. Requires a local or remote ?three=1 URL.
// Usage: node tools/capture-three-p35.mjs [baseUrl]
...
const outDir = join(root, 'briefs/2026-09-17-three-art-gap/qa-loop/p35');
...
async function serveLocal() {
  ...
  return { server, url: 'http://127.0.0.1:4179/index.html?three=1' };
}
